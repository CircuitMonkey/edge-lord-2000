...
//#define OLED_CS 5
//#define OLED_DC 4
const uint8_t OLED_CS = 5;
const uint8_t OLED_DC = 4;
...
// software SPI
//Adafruit_SSD1327 display((uint8_t)128, (uint8_t)128, OLED_MOSI, OLED_CLK, OLED_DC, OLED_RESET, OLED_CS);
// hardware SPI
//Adafruit_SSD1327 display(128, 128, &SPI, OLED_DC, OLED_RESET, OLED_CS);

// I2C
// SDA = 21,  SCK = 22,  RST = 15
